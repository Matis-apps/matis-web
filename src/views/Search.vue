            ...
            <div :class="'col-'+Math.floor(12/albums.length)" v-for="items in albums" v-bind:key="items._uid">
              <div class="row">
                ...
                <div class="col-lg-10 col-md-9 col-sm-8">
                  ...
                  <div class="row">
                    <p><span><a :href="items.link" class="text-success" target="_blank" rel="noopener">{{ items.name }}</a></span><span v-for="artist in items.artists" v-bind:key="artist._uid"> | <a :href="artist.link" class="text-primary" target="_blank" rel="noopener">{{ artist.name }}</a></span></p>
                  </div>
                </div>
              </div>
            </div>
